...
read_key_exists_test() ->
  ...
  {Response, State2} = ch8_crud_map:read(Key, State),
...
write_adds_new_value_test() ->
  ...
  {Response, State2} = ch8_crud_map:write(Request, State),
...
delete_existing_key_value_test() ->
  ...
  {Response, State2} = ch8_crud_map:delete(Key, State),
